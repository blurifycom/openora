...
function makeEvents(): import('@oss/core').EventBus {
...
function makeManualDrizzle(db: Record<string, unknown>): import('@oss/db').DrizzleService {
  return { db } as unknown as import('@oss/db').DrizzleService;
}
