/**
 * @oss/client - typed end-to-end client for the OSS platform.
 *
 ...
 * strings, no response casts.
 *
 * ```ts
 * import { createClient } from '@oss/react-sdk';
 *
 ...
 * const user = await client.backoffice.updateUser({ userId, isActive: true });
