...
import { usePlayerDetailActions, usePlayerDetailSections } from '../ui-plugin/registry.js';
...
export function PlayerDetailPage({
  ...
  const pluginSections = usePlayerDetailSections();
  const pluginActions = usePlayerDetailActions();
    ...
    <>
      <div className="page-header">
        ...
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          {pluginActions.map((a) => (
            <Fragment key={a.id}>{a.render(player)}</Fragment>
          ))}
