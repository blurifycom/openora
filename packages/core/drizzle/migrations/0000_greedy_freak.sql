...
CREATE INDEX "audit_log_tenant_seq_idx" ON "audit_log" USING btree ("tenantId","seq");--> statement-breakpoint
...
CREATE INDEX "admin_role_permission_tenantId_roleId_idx" ON "admin_role_permission" USING btree ("tenantId","roleId");--> statement-breakpoint
...
CREATE INDEX "wallet_transaction_tenantId_idx" ON "wallet_transaction" USING btree ("tenantId");