...
// .../packages/core/src/server/db/__tests__ -> repo root is six levels up.
const repoRoot = resolve(here, '../../../../../..');
// The central migration history + drizzle.config.ts now live at the @oss/core
// package root (the db engine folded into @oss/core/server). See ADR-0025.
