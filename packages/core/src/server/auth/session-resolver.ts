...
export class SessionResolver {
  ...
  // getSession() throws "model session not found" without it. @oss/core/server can't
  // import the schema (it lives in the @oss/pam identity module), so createApp injects it.
