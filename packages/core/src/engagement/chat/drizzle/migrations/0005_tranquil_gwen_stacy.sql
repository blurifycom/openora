...
ALTER TYPE "public"."chat_room_role" ADD VALUE 'owner';--> statement-breakpoint
CREATE TABLE "chat_mute" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" uuid NOT NULL,
	"room_id" uuid,
	"scope" "chat_moderation_scope" DEFAULT '__global' NOT NULL,
...
CREATE TABLE "chat_platform_ban" (
	...
	"scope" "chat_moderation_scope" DEFAULT '__all_public' NOT NULL,
	"room_id" uuid,
	"reason" text NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"expires_at" timestamp with time zone,
...
ALTER TABLE "chat_room" ALTER COLUMN "category" DROP NOT NULL;--> statement-breakpoint
...
ALTER TABLE "chat_platform_ban" ADD CONSTRAINT "chat_platform_ban_room_id_chat_room_id_fk" FOREIGN KEY ("room_id") REFERENCES "public"."chat_room"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "chat_platform_ban_user_idx" ON "chat_platform_ban" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX "chat_msg_deleted_at_idx" ON "chat_message" USING btree ("deleted_at");--> statement-breakpoint
