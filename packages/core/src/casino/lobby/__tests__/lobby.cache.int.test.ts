...
beforeEach(async () => {
  await db.drizzle.db.execute(
    sql`TRUNCATE ${lobbySection}, ${lobbyLayout}, ${featuredSlot}, ${lobbyCategoryGame}, ${lobbyCategory}, ${gameCategoryGame}, ${gameTagGame}, ${game}, ${gameProvider}, ${gameCategory}, ${gameTag} RESTART IDENTITY CASCADE`,
  );
  await redis.flush();
});
