...
//
// `tx` is the active transaction handle, typed `unknown` here to keep @oss/core/contracts
// ORM-free; the Drizzle implementation in @oss/core/server narrows it. Services never touch
