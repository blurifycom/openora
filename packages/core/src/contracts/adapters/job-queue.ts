...
export type EnqueueOptions = {
  ...
  /** Lower = sooner; a driver may ignore it. */
  priority?: number;
  /** Drop the job if not started within this window. */
  ttlMs?: number;
 ...
 * callers pass their schema directly - but @openora/core/contracts stays zod-free (every
