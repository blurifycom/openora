---
description: >-
  Messaging seams (broker / job-queue / realtime), command vs event vs job, the
  event envelope, outbox, and the service-manifest path to microservices.
applyTo: 'packages/**,extensions/**'
---
