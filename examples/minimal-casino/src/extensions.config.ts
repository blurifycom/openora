...
// This example assumes a sibling layout: the consumer repo lives next to casino-oss.
// From this file (examples/minimal-casino/src) the OSS modules dist is two levels up.
const OSS_MODULES = resolve(here, '../../casino-oss/packages/modules/dist');
...
export const extensions: PluginEntry[] = [
  ...
  // Player - the player-facing casino surface. `wallet` binds a default
