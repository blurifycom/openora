...
Generated from `docs/catalog.json` - 20 modules, 287 routes, 48 adapter ports, 127 events. Edit the code, then run `pnpm gen:catalog`.
...
| `@openora/core/pam`           | identity · player-management · player-note · profile · tag | account, admin_trusted_device, phone_verification_session, player + 9 more          | 67     |
