...
Generated from `docs/catalog.json` - 20 modules, 263 routes, 45 adapter ports, 116 events. Edit the code, then run `pnpm gen:catalog`.
...
| `@openora/core/compliance`    | compliance                                                 | country_rule, global_kyc_config, kyc_verification, rg_exclusion + 2 more            | 28     |
