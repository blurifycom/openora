...
Generated from `docs/catalog.json` - 20 modules, 288 routes, 49 adapter ports, 128 events. Edit the code, then run `pnpm gen:catalog`.
...
| `@openora/core/casino`        | gaming · lobby                                             | featured_slot, game, game_category, game_category_game + 7 more                     | 26     |
...
| `@openora/core/pam`           | identity · player-management · player-note · profile · tag | account, admin_trusted_device, phone_verification_session, player + 9 more          | 68     |
