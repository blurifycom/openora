...
Generated from `docs/catalog.json` - 20 modules, 225 routes, 44 adapter ports, 91 events. Edit the code, then run `pnpm gen:catalog`.
...
| `fx`                          | exchange-rate                                                    | exchange_rate_quote                                                                 | 1      |
