...
| **Plugin** / **extension** / **overlay** | A drop-in unit that adds or overrides behavior via `definePlugin({ id, register })`. The only way new functionality enters the system.                                                                                                                  | `extensions/*`, consumer plugins                                                          |
