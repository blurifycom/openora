...
> **Update (2026-07-25)**: [ADR-0039](./0039-tests-run-the-production-seams.md) deleted `InMemoryBroker` - every tier binds `RedisStreamsBroker`. The envelope shape and the adapter interface are still exactly as decided here.
