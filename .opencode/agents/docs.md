---
description: >-
  Audits prose docs against the actual codebase and edits them to match (stale
  paths, removed modules, drifted claims). Edits docs only, never code; finishes
  with `pnpm gen:agents` to refresh generated mirrors.
mode: subagent
name: docs
---
