---
description: >-
  Scaffold and write an Architecture Decision Record. Arg: short title (eg /adr
  split wallet into its own service). Use for any decision that changes
  architecture, boundaries, seams, or conventions.
---
