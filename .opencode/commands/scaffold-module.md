---
description: >-
  Generate a new OSS module via turbo gen. Creates schema, contract, service,
  router, plugin.ts, a working `list` route, and wires the domain barrels,
  @openora/core exports, contract slice, and extensions.config.ts.
---
