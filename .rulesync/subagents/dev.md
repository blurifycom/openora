...
1. Read root `AGENTS.md` (decision tree, boundaries, forbidden patterns) and the sibling rules (`conventions`, `clean-architecture`, `messaging-and-microservices`, `db-conventions`). Follow exactly.
