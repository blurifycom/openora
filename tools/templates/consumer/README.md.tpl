...
- `qa` - verify a change by hand, capture screenshot evidence, propose the tests, triage bugs
- `debugger`, `deployer`, `quality-reviewer`, `security-reviewer`, `compliance-reviewer` - root-cause, packaging, review
