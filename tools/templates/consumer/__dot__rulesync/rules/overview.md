...
Canonical brief for AI agents (Claude Code, GitHub Copilot, Gemini) and humans working on
this repo. Every per-tool instruction file (`AGENTS.md`, `CLAUDE.md`, `GEMINI.md`,
`.github/copilot-instructions.md`) plus the subagent and command mirrors are generated by
